...
var (
	...
	perfReplicationGroupMemberStats = map[string]struct {
		...
		"COUNT_TRANSACTIONS_IN_QUEUE": {prometheus.GaugeValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_transactions_in_queue"),
		...
		"COUNT_TRANSACTIONS_CHECKED": {prometheus.CounterValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_transactions_checked"),
				"The number of transactions that have been checked for conflicts.", nil, nil)},
		"COUNT_CONFLICTS_DETECTED": {prometheus.CounterValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_conflicts_detected"),
		...
		"COUNT_TRANSACTIONS_ROWS_VALIDATING": {prometheus.CounterValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_transactions_rows_validating"),
		...
		"COUNT_TRANSACTIONS_REMOTE_IN_APPLIER_QUEUE": {prometheus.GaugeValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_transactions_remote_in_applier_queue"),
		...
		"COUNT_TRANSACTIONS_REMOTE_APPLIED": {prometheus.CounterValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_transactions_remote_applied"),
		...
		"COUNT_TRANSACTIONS_LOCAL_PROPOSED": {prometheus.CounterValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_transactions_local_proposed"),
		...
		"COUNT_TRANSACTIONS_LOCAL_ROLLBACK": {prometheus.CounterValue,
			prometheus.NewDesc(prometheus.BuildFQName(namespace, performanceSchema, "count_transactions_local_rollback"),
